...
class Dawn:
    ...
    def log(self, message):
        print(
            f"{Fore.CYAN + Style.BRIGHT}[ {datetime.now().astimezone(wib).strftime('%x %X %Z')} ]{Style.RESET_ALL} FORESTARMY"
    ...
    def welcome(self):
        print(
            f"""    {Fore.GREEN + Style.BRIGHT}Dawn - BOT |  {Fore.YELLOW + Style.BRIGHT}MUST SUBSCRIBE - Join https://t.me/forestarmy)
            """
        )
